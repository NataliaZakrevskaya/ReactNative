...
const GettingServiceModal = ( { closeModal }: any ) => {
  return (
    <View style={ styles.centeredView }>
      <View style={ styles.modalView }>
        <View>
          <Text style={ [ styles.text, styles.mainText, { textAlign: 'center', marginBottom: 20 } ] }>
            Для получение подарочного товара или услуги
          </Text>
          <Text style={ [ styles.text, { marginBottom: 15, fontSize: 12 } ] }>1. Вам нужно связаться с сотрудником
            диллерского центра</Text>
          <Text style={ [ styles.text, { marginBottom: 24, fontSize: 12 } ] }>2. Сотрудник подскажет где вы можете
            получить свой подарок</Text>
        </View>
        <View style={ {
          display: 'flex',
          flexDirection: 'row',
...
export default GettingServiceModal;