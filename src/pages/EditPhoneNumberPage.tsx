  ...
  return (
    <View style={ styles.container }>
      <View style={ styles.oldNameBlock }>
        <Text style={ [ styles.text, { color: '#07A95B', marginLeft: 7 } ] }>Текущий номер телефона</Text>
      ...
      <View style={ {
        ...
        <Text style={ [ styles.text, { color: '#07A95B', marginLeft: 7 } ] }>Новый номер телефона</Text>
        <TextInput
          value={ text }
